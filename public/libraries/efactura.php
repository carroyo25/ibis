<?php
	...
	require 'public/libraries/see/lib/xmlseclibs-master/xmlseclibs.php';
	class Factura{
	...
	//		$publicKey = file_get_contents('prueba/server.pem');
			...
			$privateKey = file_get_contents("public/libraries/certificado_digital/server_key.pem");
			$publicKey = file_get_contents("public/libraries/certificado_digital/server.pem");
