<?php 
    ...
    class PDF extends FPDF{
		...
		function Header() {
			...
			$this->Cell(5,4,$this->transferencia == 274 ? "X":"",1,0,"C");
			$this->SetX(40);
			...
			$this->Cell(5,4,$this->transferencia == 273 ? "X": "",1,0,"C");
			$this->SetX(40);
		...
		function Footer(){
			...
			$logistica = $path.'/ibis/public/documentos/autorizaciones/firmas_logistica/'.$this->logistica.'.png';

			if (file_exists($logistica)){
				$this->Image($logistica,100,260,15);
			}
