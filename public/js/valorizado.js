...
async function crearCarpeta() {
  ...
  let nombreCarpeta = "OC 000734";
  try {
    const nuevaCarpeta = await directorioRaiz.getDirectoryHandle(nombreCarpeta,{ create: true },);
    //actualizarEstado(`Carpeta "${nombreCarpeta}" creada exitosamente`);
    document.getElementById("nombre-carpeta").value = "";
    //await listarContenido();
  } catch (error) {
    //actualizarEstado("Error al crear carpeta: " + error.message, true);
  }
}
