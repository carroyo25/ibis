...
<body>
    <div class="modal oculto" id="document_check">
        <div class="wrap_modal">
            <div class="preview">
                <div class="tituloVista">
                    <h3>Vista Previa</h3>
                    <a href="#" id="closePreview" title="Cerrar Ventana" class="modal_children_close"><i class="fas fa-window-close"></i></a>
                </div>
                <div class="frame">
                    <iframe id="framePreview" src=""></iframe>
                </div>
                <div class="acciones">
    ...
    <div class="wrap">
        ...
        <nav class="wrap_nav">
            <div class="acciones_archivo">
                <a href="click_verify" class="botones__click_accion"><i class="fas fa-edit"></i> <p>Verificar Documentos</p></a>
                <a href="click_download" class="botones__click_accion"><i class="fas fa-download"></i><p>Descargar <br/> Archivos</p></a>
                <a href="click_send_ok" class="botones__click_accion"><i class="fas fa-mail-bulk"></i><p>Enviar <br/> Conformidad</p></a>
            </div>
    ...
    <script src="../../js/administradocumentospanel.js?<?php echo $version = rand(0, 9999); ?>"" type="module"></script>
</body>
</html>