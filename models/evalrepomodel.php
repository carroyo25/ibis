    ...
    class EvalrepoModel extends Model{
        ...
        private function servicios($anio,$mes){
                $sql = $this->db->connect()->prepare("SELECT
                                                            ...
                                                            lg_ordencab.cnumero,
                                                            lg_ordencab.ncodcos,
                                                            IFNULL( c25.npuntaje, 3 ) AS c25,
                                                            IFNULL( c26.npuntaje, 3 ) AS c26,
                                                            IFNULL( c27.npuntaje, 3 ) AS c27,
                                                            IFNULL( c28.npuntaje, 3 ) AS c28,
                                                            IFNULL( c29.npuntaje, 3 ) AS c29,
                                                            IFNULL( c30.npuntaje, 3 ) AS c30,
                                                            IFNULL( c31.npuntaje, 3 ) AS c31,
                                                            IFNULL( c32.npuntaje, 3 ) AS c32,
                                                            IFNULL( c33.npuntaje, 3 ) AS c33,
                                                            IFNULL( c34.npuntaje, 3 ) AS c34,
                                                            IFNULL( c45.npuntaje, 3 ) AS c45,
                                                            IFNULL( c46.npuntaje, 3 ) AS c46,
                                                            IFNULL( c47.npuntaje, 3 ) AS c47,
                                                            IFNULL( c48.npuntaje, 3 ) AS c48,
                                                            IFNULL( c49.npuntaje, 3 ) AS c49,
                                                            IFNULL( c50.npuntaje, 3 ) AS c50,
                                                            IFNULL( c51.npuntaje, 3 ) AS c51,
                                                            IFNULL( c52.npuntaje, 3 ) AS c52 
                                                        FROM
                                                            lg_ordencab
                                                            INNER JOIN cm_entidad ON lg_ordencab.id_centi = cm_entidad.id_centi
                                                            INNER JOIN tb_proyectos ON lg_ordencab.ncodcos = tb_proyectos.nidreg
        ...
        private function compras($anio,$mes){
                $sql = $this->db->connect()->prepare("SELECT
                                                        ...
                                                        lg_ordencab.cnumero,
                                                        lg_ordencab.ncodcos,
                                                        IFNULL( c1.npuntaje, 3 ) AS c1,
                                                        IFNULL( c2.npuntaje, 3 ) AS c2,
                                                        IFNULL( c3.npuntaje, 3 ) AS c3,
                                                        IFNULL( c4.npuntaje, 3 ) AS c4,
                                                        IFNULL( c5.npuntaje, 3 ) AS c5,
                                                        IFNULL( c6.npuntaje, 3 ) AS c6,
                                                        IFNULL( c7.npuntaje, 3 ) AS c7,
                                                        IFNULL( c8.npuntaje, 3 ) AS c8,
                                                        IFNULL( c9.npuntaje, 3 ) AS c9,
                                                        IFNULL( c10.npuntaje, 3 ) AS c10,
                                                        IFNULL( c11.npuntaje, 3 ) AS c11,
                                                        IFNULL( c12.npuntaje, 3 ) AS c12,
                                                        IFNULL( c13.npuntaje, 3 ) AS c13,
                                                        IFNULL( c14.npuntaje, 3 ) AS c14,
                                                        IFNULL( c15.npuntaje, 3 ) AS c15,
                                                        IFNULL( c16.npuntaje, 3 ) AS c16,
                                                        IFNULL( c17.npuntaje, 3 ) AS c17,
                                                        IFNULL( c18.npuntaje, 3 ) AS c18,
                                                        IFNULL( c19.npuntaje, 3 ) AS c19,
                                                        IFNULL( c20.npuntaje, 3 ) AS c20,
                                                        IFNULL( c39.npuntaje, 3 ) AS c39,
                                                        IFNULL( c41.npuntaje, 3 ) AS c41,
                                                        IFNULL( c42.npuntaje, 3 ) AS c42,
                                                        IFNULL( c43.npuntaje, 3 ) AS c43,
                                                        IFNULL( c44.npuntaje, 3 ) AS c44,
                                                        IFNULL( c53.npuntaje, 3 ) AS c53,
                                                        IFNULL( c54.npuntaje, 3 ) AS c54,
                                                        IFNULL( c55.npuntaje, 3 ) AS c55 
                                                    FROM
                                                        lg_ordencab
                                                        INNER JOIN cm_entidad ON lg_ordencab.id_centi = cm_entidad.id_centi
                                                        INNER JOIN tb_proyectos ON lg_ordencab.ncodcos = tb_proyectos.nidreg
