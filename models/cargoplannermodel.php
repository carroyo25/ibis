                ...
                if($rowCount > 0) {
                    while($rs = $sql->fetch()){
                        ...
                        if($semaforoEstado == "Verde" ) {
                            $color_semaforo = '90EE90';
                        }else if($semaforoEstado == "Entregado" ) {
                            $color_semaforo = '90EE90';
                        }else if($semaforoEstado == "Naranja" ) {
                            $color_semaforo = 'FFD700';
                        ...
                        //$objPHPExcel->getActiveSheet()->setCellValue('K'.$fila,$datos[$i]->apro_pedido);
                        //if  ($rs['aprobacion_pedido'] !== ""){
                        //$objPHPExcel->getActiveSheet()->setCellValue('K'.$fila,PHPExcel_Shared_Date::PHPToExcel($rs['aprobacion_pedido']));
                        //$objPHPExcel->getActiveSheet()->getStyle('K'.$fila)->getNumberFormat()->setFormatCode('dd/mm/yyyy');
                        //}
                        ...
                        $objPHPExcel->getActiveSheet()->setCellValue('P'.$fila,$clase_operacion);
